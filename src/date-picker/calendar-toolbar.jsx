...
const CalendarToolbar = React.createClass({
  ...
  render() {
    ...
    const nextButtonIcon = this.props.muiTheme.isRtl ? <NavigationChevronRight /> : <NavigationChevronLeft />;
    const prevButtonIcon = this.props.muiTheme.isRtl ? <NavigationChevronLeft /> : <NavigationChevronRight />;
...
export default themeable(CalendarToolbar);
